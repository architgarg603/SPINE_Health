...
const Navbar = () => {
    ...
    return (
        <AppBar position="static" sx={{
            ...
            <Container maxWidth="xl" sx={{ background: "white", width: "100%", borderBottom: '2px solid #1dc5ae' , boxShadow: "5px 2px 4px -1px rgb(0 0 0 / 20%), 5px 4px 5px 0px rgb(0 0 0 / 14%), 5px 1px 10px 0px rgb(0 0 0 / 12%)" }}>
